...
public class SanPhamChiTietJFrame extends javax.swing.JFrame {
    ...
    public SanPhamChiTietJFrame(int maSP) {
        this.tblModel = new DefaultTableModel(); // hoặc khởi tạo theo dữ liệu thực tế của bạn
        ...
        for (int row = 0; row < tblModel.getRowCount(); row++) {
            for (int col = 0; col < tblModel.getColumnCount(); col++) {
                System.out.print(tblModel.getValueAt(row, col) + "\t");
            }
            System.out.println();
        }
...
//        if (selectedRowIndex < 0 || selectedRowIndex >= tblModel.getRowCount()) {
